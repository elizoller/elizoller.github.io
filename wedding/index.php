...
<body id="page-top">
  ...
  <div id="home" class="home">
    <div class="home-header">
      <h1>Gina &amp; Eli</h1>
      <h2>October 3<sup>rd</sup> 2015</h2>
      <h2>Groton, MA</h2>
  ...
  <div id="about" class="pad-section">
    ...
    <div class="col-sm-4">
    <div class="thumbnail">
      <img src="img/elibw2.png" alt="Eli">
      <div class="caption">
      <h3>Eli</h3>
      <p>Eli is an all-around quirky guy. By day, he is a librarian building websites. By night, he enjoys reading sci fi, playing with their cats, and riding bikes. He has a passion for skinny ties and obsessively matches his bizarre (argyles, dinosaurs, and sharks) socks to his shirts. His favorite foods include broccoli, peanut butter, raspberries, and eggplant pizza. He feels incredibly lucky to have Gina in his life.</p>
    </div>
</div><!-- .thumbnails -->
    </div><!-- .col-->
    </div><!-- .row-->
  ...
  <div id="bigday" class="pad-section">
    <div class="container">
      <h2 class="text-center">The Big Day</h2> <hr />
      <div class="row text-center">
        <div class="col-sm-3 col-sm-offset-3">
          <img src="img/wedding6.png" class="glyphicon" alt="wedding rings">
          <h4>Ceremony</h4>
          <h5>10:30 am</h5>
        </div>
        <div class="col-sm-3">
  ...
  <div id="travel" class="pad-section">
    <div class="container">
      <div class="row">
        <h3>Where to Stay</h3>
  ...
  <!-- sixth section -->
  <div id="registry" class="pad-section">
    <div class="container">
      <div class="row">
        <div class="col-sm-12 text-center">
          <h3>Visit Our Registries</h3>
          <br/>
        ...
        <div class="col-sm-12 text-center">
          ...
          <form class="form" action="contact.php" method="post">
            <div class="form-group row">
              <label for="name" class="control-label col-sm-2 col-sm-offset-3">Your Name: </label>
              <div class="col-sm-4">
                <input type="text" class="form-control" placeholder="Enter your name" name="name">
              </div>
            </div>
            <div class="form-group row">
              <label for="contact" class="control-label col-sm-2 col-sm-offset-3">How can we contact you? </label>
              <div class="col-sm-4">
                <input type="text" class="form-control" placeholder="Your email or phone number" name="contact">
              </div>
            </div>
            <div class="form-group row">
              <label for="comment" class="control-label col-sm-2 col-sm-offset-3">Your comment: </label>
              <div class="col-sm-4">
